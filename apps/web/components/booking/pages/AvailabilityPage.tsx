...
const useSlots = ({
  ...
  useEffect(() => {
    if (data?.slots) {
      ...
      // @ts-ignore
      setCachedSlots((c: Record<string, unknown>) => ({ ...c, ...data?.slots }));
    }
  }, [data]);
      ...
      <div>
        <main
          ...
          <div
            ...
            className={classNames(
              isBackgroundTransparent ? "" : "bg-white dark:bg-gray-500",
              "border-bookinglightest overflow-hidden rounded-md shadow-sm",
                        ...
                        <div className="dark:text-darkgray-600 flex items-center text-gray-600">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-15 sellular-input--text h-7"
